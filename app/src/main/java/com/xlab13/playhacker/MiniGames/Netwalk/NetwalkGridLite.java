 ...
 */
public class NetwalkGridLite implements Parcelable {
    ...
    public NetwalkGridLite(int columns, int rows) {
        if (columns + rows <= 1) {
    ...
    protected NetwalkGridLite(Parcel in) {
    ...
    public static final Creator<NetwalkGridLite> CREATOR = new Creator<NetwalkGridLite>() {
        @Override
        public NetwalkGridLite createFromParcel(Parcel source) {
            return new NetwalkGridLite(source);
        }

        @Override
        public NetwalkGridLite[] newArray(int size) {
            return new NetwalkGridLite[size];
        }
    };
